...
public class SecurityConfigurations extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.and().addFilterBefore(new AutenticacaoViaTokenFilter(tokenService, lojistaRepository), UsernamePasswordAuthenticationFilter.class);
	}
	
	@Override
	//configurações de recursos estáticos(requisiçõs para arquivos CSS, JavaScript, imagens)
